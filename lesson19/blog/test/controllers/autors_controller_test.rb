...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference("Autor.count") do
      post autors_url, params: { autor: { age: @autor.age, city: @autor.city, name: @autor.name } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { age: @autor.age, city: @autor.city, name: @autor.name } }
